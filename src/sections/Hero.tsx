  ...
  return (
    <section id="hero" className="relative min-h-[92vh] flex items-center overflow-hidden">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[1100px] h-[1100px] rounded-full bg-gradient-to-br from-teal-500/10 via-cyan-400/5 to-transparent blur-3xl" />
      ...
      <div className="container-section w-full pt-24 pb-24 relative">
        <div className="max-w-4xl">
          <motion.p initial={{opacity:0,y:10}} animate={{opacity:1,y:0}} transition={{duration:0.5}} className="text-teal-300/80 text-xs md:text-sm mb-5 tracking-[0.35em] font-mono">Hi, my name is</motion.p>
          <motion.h1 initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.65, delay:0.05}} className="text-5xl md:text-7xl font-bold text-white mb-6 leading-[1.05] relative">
            ...
            <span className="block mt-2 text-white/50 text-3xl md:text-4xl font-light tracking-tight">
